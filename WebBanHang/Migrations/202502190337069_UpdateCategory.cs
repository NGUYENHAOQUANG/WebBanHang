namespace WebBanHang.Migrations
{
    ...
    public partial class UpdateCategory : DbMigration
    {
        public override void Up()
        {
            ...
            AlterColumn("dbo.tb_Category", "SeoTtile", c => c.String(maxLength: 150));
            AlterColumn("dbo.tb_Category", "SeoDecription", c => c.String(maxLength: 250));
        ...
        public override void Down()
        {
            ...
            AlterColumn("dbo.tb_Category", "SeoDecription", c => c.String());
            AlterColumn("dbo.tb_Category", "SeoTtile", c => c.String());
